    ...
    body: ListView(
      ...
      children: [
        ...
        _sectionBorder(
          ...
          title: 'Kriteria yang Dibutuhkan',
          content: opd.kriteria ?? 'Kriteria khusus belum ditentukan oleh instansi ini.',
        ),
        // Info items
                ...
                children: [
                  ...
                  FilledButton(
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => PendaftaranPage(selectedOpd: opd)),
                    ),
